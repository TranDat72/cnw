	...
	<div class="container-fluid">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<a href="add.php">
					<button class="btn" style="">Thêm cán bộ</button>
				</a>
				<a href="../../index.php">
					<button class="btn" style=""> Trang chủ </button>
				</a><form action="">
					<button style=" " class="btn">Lọc</button>
				<select class="btn"  name="id_donvi" value="<?=$dv?>" style=" "> Đơn Vị 
